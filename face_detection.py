...
def main():
    st.title("🎭 Enhanced Face Detection")
    st.markdown("""
    ...
    with st.expander("📖 How to use this app"):
        ...
        5. Try different images and settings for best results!
        
        *Note: For best results, use clear front-facing photos with good lighting.*
        """)
